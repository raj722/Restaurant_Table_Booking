      ...
      <section className="relative min-h-screen">
        ...
        <div className="relative flex items-center justify-center min-h-screen">
          <div className="px-6 text-center text-white">
            ...
            {/* Smooth Scroll to Featured Restaurants */}
            <ScrollLink
              to="featured-restaurants"
              smooth={true}
              duration={800}
              offset={-50} // Adjust offset for header if needed
            >
      ...
      <section id="about-us" className="py-16 bg-gray-100">
        ...
        <div className="container px-6 mx-auto">
          <div className="grid items-center grid-cols-1 gap-8 md:grid-cols-3">
            {/* Clickable Image (1/3 width on medium screens) */}
            ...
            {/* Description (2/3 width on medium screens) */}

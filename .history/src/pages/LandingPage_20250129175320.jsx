...
const LandingPage = () => {
  return (
    <div className="relative min-h-screen">
      ...
      {/* About Us Section */}
      <section id="about-us" className="flex items-center justify-center py-16 bg-gray-100">
        <div className="container flex flex-col items-center justify-center px-6 mx-auto md:flex-row">
          {/* Image on the left */}

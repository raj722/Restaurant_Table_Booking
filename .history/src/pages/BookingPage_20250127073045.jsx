...
const BookingPage = () => {
  ...
  const restaurants = [
    ...
    {
      id: "2", // Add unique ID for each restaurant
      name: "Hyatt",
      rating: "Awesome",
      reviews: "1595",
      price: "NRS",
    ...
    {
      id: "3", // Add unique ID for each restaurant
      name: "Everest Dine",
      rating: "Excellent",
      reviews: "1203",
      price: "NRS",
    ...
    {
      id: "4", // Add unique ID for each restaurant
      name: "Durbar Palace",
      rating: "Great",
      reviews: "870",
      price: "NRS",
        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2">
          {filteredRestaurants.length > 0 ? (
            filteredRestaurants.map((restaurant, index) => (
              <Link
                to={`/restaurant/${restaurant.id}`} // Link to the restaurant details page
                key={restaurant.id}

...
import KhaltiCheckout from "khalti-checkout-web"; // Import Khalti Checkout SDK
...
const RestaurantDetailsPage = () => {
  ...
  const config = {
    publicKey: process.env.NEXT_PUBLIC_KHALTI_PUBLIC_KEY, // Use your public key from .env.local
    productIdentity: `reservation_${id}`, // Unique identifier for the reservation
    ...
    eventHandler: {
      onSuccess(payload) {
        ...
        setShowPopup(false);
        // You can send the payload to your backend for further processing
      },
      onError(error) {
  ...
  const confirmPayment = () => {
    ...
    checkout.show({ amount: 50000 }); // Amount in paisa (50000 paisa = Rs. 500)
  };

...
const RestaurantDetailsPage = () => {
  ...
  const config = {
    publicKey: publicKey, // Use the public key from environment variables
    productIdentity: `reservation_${id}`,
    ...
    eventHandler: {
      onSuccess(payload) {
        ...
        // You can add additional logic here, like sending reservation data to your backend
      },
      onError(error) {

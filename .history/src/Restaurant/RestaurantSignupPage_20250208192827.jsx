  ...
  return (
    ...
    >
      <div className="w-full max-w-md p-8 bg-gray-300 rounded-lg shadow-lg backdrop-blur-sm">
        <h2 className="mb-6 text-2xl font-bold text-center text-gray-800">Register Your Restaurant</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block mb-2 text-gray-700">Restaurant Address</label>
            <textarea
              id="address"
          ...
          <div>
            <label className="block mb-2 text-gray-700">Cuisine Type</label>
            <select
              id="cuisineType"

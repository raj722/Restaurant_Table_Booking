...
const RestaurantLoginPage = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // Fetch user role from Firestore (Ensure correct collection name)
      const userDoc = await getDoc(doc(db, "RestaurantUsers", user.uid));
      ...
      if (userDoc.exists()) {
        ...
        if (role === "RestaurantUser") {
          navigate("/restaurant-dashboard"); // ✅ Corrected navigation for RestaurantUser
        ...
        setError("User role not found. Please try again.");
      }

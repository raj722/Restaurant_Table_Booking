...
const SignupPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const role = isRestaurantSignup ? 'restaurant' : 'customer'; // Assign role based on signup type
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="mt-6">
            <button
              ...
              className="w-full py-3 text-white transition-all duration-300 transform bg-green-500 rounded-lg shadow-lg hover:bg-green-600 hover:scale-105 active:scale-95 focus:outline-none focus:ring-2 focus:ring-green-400"
            >
